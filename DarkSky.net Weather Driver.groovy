...
def initialize() {
	...
	if(pollIntervalForecast == "Manual Poll Only"){
		LOGINFO("MANUAL DARKSKY POLLING ONLY")
	} else {
...
@Field static attributesMap = [
	...
	"nearestStormBearing":  	[title: "Nearest Storm Bearing", descr: "Display 'nearestStormBearing'?", typeof: "number", default: "false"],
	"nearestStormCardinal":		[title: "Nearest Storm Cardinal", descr: "Display 'nearestStormCardinal'?", typeof: "string", default: "false"],    	
	"nearestStormDirection":	[title: "Nearest Storm Direction", descr: "Display 'nearestStormDirection'?", typeof: "string", default: "false"],    		
	"nearestStormDistance":    	[title: "Nearest Storm Distance", descr: "Display 'nearestStormDistance'?", typeof: "number", default: "false"],    		
